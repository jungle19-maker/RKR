            ...
            <div className="container mx-auto px-6 max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    ...
                    <div className="lg:sticky lg:top-28">
                        ...
                        <a
                            href="#contact"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-[#22C55E] hover:bg-[#16a34a] text-[#23352b] font-bold text-sm transition-all shadow hover:shadow-[#22C55E]/30 hover:-translate-y-0.5"
                        >
                            ...
                            return (
                                <div
                                    ...
                                    className={` rounded-2xl border transition-all duration-300 overflow-hidden ${isOpen
                                        ? "border-[#22C55E] bg-white shadow-lg"
                                        : "border-[#E5E7EB] bg-white hover:border-[#22C55E]/50 hover:shadow-md"
                                        }`}
                                >
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className={`flex-shrink-0 ml-3 w-6 h-6 flex items-center justify-center transition-colors ${isOpen ? "bg-[#22C55E] text-[#23352b]" : "bg-[#F1F5F9] text-[#4B5563]"
                                            }`}>
                                            {isOpen
