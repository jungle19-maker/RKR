...
export const metadata: Metadata = {
  title: 'Our Process | New RKR Manpower Consultant',
      ...
      <div className="flex-grow">
        ...
        <section className="relative bg-white py-24 text-center border-b border-[#E5E7EB] overflow-hidden">
          ...
          <div className="container mx-auto px-6 max-w-4xl relative z-10">
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#24342b] mb-4">Our <span className="text-[#22C55E]">Process</span></h1>
          </div>
        </section>
