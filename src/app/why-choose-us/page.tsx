...
export const metadata: Metadata = {
  title: 'Why Choose Us | New RKR Manpower Consultant',
  description: 'Discover why New RKR Manpower Consultant is your trusted MEA-approved global manpower recruitment partner.',
  alternates: {
